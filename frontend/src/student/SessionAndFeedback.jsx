...
export default function SessionAndFeedback() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen w-full bg-slate-50 flex items-center justify-center pt-16">
    ...
    <div className="min-h-screen w-full bg-slate-50 flex flex-col pt-16">
      <div className="flex-1 w-full mx-auto px-2 sm:px-4 py-2 sm:py-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 sm:gap-3">
          ...
          >
            <div className="bg-white rounded-lg border border-slate-200 p-2 sm:p-4 h-[calc(100vh-5rem)] sm:h-[calc(100vh-4rem)] flex flex-col overflow-y-auto">
                ...
                >
                  ...
                  <div className="border-b border-slate-200 pb-3 sm:pb-4">
                    <div className="flex items-center justify-between mb-2 sm:mb-3">
                      ...
                      <div className="flex items-center gap-2 px-2 sm:px-3 py-1 bg-green-100 text-green-700 rounded-full">
                  ...
                  {/* Event Details Card */}
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-3 sm:p-5 border border-blue-200">
                    ...
                    <div className="bg-white rounded-lg border border-slate-200 p-3 sm:p-5">
                      ...
                      <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-5">
                        {Object.entries(criteriaLabels).map(([key, label]) => {
                          ...
                          return (
                            <div key={key} className="flex items-center justify-between p-2 sm:p-3 bg-slate-50 rounded-lg">
                              ...
                              <div className="flex items-center gap-1 sm:gap-2">
                                ...
                                <span className="text-xs sm:text-sm font-bold text-gray-700 ml-1 sm:ml-2 min-w-[2rem]">
                                  {value}/5
                                </span>
                              </div>
                            </div>
                      ...
                      <div className="bg-gradient-to-r from-blue-100 to-indigo-100 rounded-lg p-3 sm:p-4 border-2 border-blue-300">
                        <div className="flex items-center justify-between">
                          <span className="text-sm sm:text-base font-bold text-gray-800">Total Score</span>
                  ...
                  {!selectedFeedback.totalMarks && selectedFeedback.marks != null && (
                    <div className="bg-gradient-to-r from-blue-100 to-indigo-100 rounded-lg p-3 sm:p-5 border-2 border-blue-300">
                      <div className="flex items-center justify-between">
